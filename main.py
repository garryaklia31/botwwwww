...
async def main():
  ...
  bot = Client("my_bot",
               api_id="23401127",
               api_hash="3c49af9303edc37c5df90ff980cdc2e4",
               bot_token="7441618233:AAEKPUpUEnOr-kmpjhqtnLWdXkI4DCuyCD8",
               plugins=plugins)
  clients = [user, bot]
...
<code>/scr https://t.me/+aGWRGz 50</code>
      ...
      if results == 'None':
        ...
        if chat_type == "ChatType.PRIVATE" and status == "FREE":
          resp = "𝗢𝗡𝗟𝗬 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗠𝗘𝗠𝗕𝗘𝗥𝗦 𝗔𝗥𝗘 𝗔𝗟𝗟𝗢𝗪𝗘𝗗 𝗧𝗢 𝗨𝗦𝗘 𝗕𝗢𝗧 𝗜𝗡 𝗣𝗘𝗥𝗦𝗢𝗡𝗔𝗟 ⚠️.𝗬𝗢𝗨 𝗖𝗔𝗡 𝗨𝗦𝗘 𝗙𝗥𝗘𝗘𝗟𝗬 𝗕𝗢𝗧 𝗛𝗘𝗥𝗘 @GARRYPLAYS"
          await message.reply_text(resp, message.id)
...
● 𝗕𝗼𝘁 𝗕𝘆: <a href="tg://user?id=1718738592">[🇮🇳 ] Garry 👑</a>
"""
                  document = file_name
